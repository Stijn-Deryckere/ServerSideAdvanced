...
namespace Week2Oefening1.Models.Services
{
    public class OrderService : Week2Oefening1.BusinessLayer.Services.IOrderService
    {
        ...
        public void SendOrderMail(Order order)
        {
            ...
            newMessage.From = new MailAddress("kristof@kristofcolpaert.com");
            newMessage.AddTo(order.User.Email);
            newMessage.Subject = "Welcome on my Internet of Things webshop";
            newMessage.Text = "Welcome on my Internet of Things webshop";

            //Make connection with SendGrid account
            NetworkCredential credentials = new NetworkCredential("kriscolp", "-Password1");

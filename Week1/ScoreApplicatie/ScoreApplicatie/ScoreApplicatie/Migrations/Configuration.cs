namespace ScoreApplicatie.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ScoreApplicatie.Models.DAL.ScoreAppContext>
    {
        ...
        protected override void Seed(ScoreAppContext context)
        {
            ...
            context.Competitions.Add(jupilerProLeage);
            context.SaveChanges();
            ...
            context.Competitions.Add(laliga);
            context.SaveChanges();
        }

...
namespace Week2Oefening1.Models.DAL
{
    public class DeviceRepository : GenericRepository<Device>, IDeviceRepository
    {
        ...
        {
            return this.context.Devices.Include(f => f.DeviceFramework).Include(o => o.DeviceOS);
        }

        public override Device GetByID(object id)
        {
            int tempId = (int)id;
            var query = from d in this.context.Devices.Include(f => f.DeviceFramework).Include(o => o.DeviceOS) where d.Id == tempId select d;

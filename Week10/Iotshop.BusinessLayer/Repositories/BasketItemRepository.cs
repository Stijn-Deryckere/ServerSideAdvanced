...
{
    public class BasketItemRepository : GenericRepository<BasketItem>, Iotshop.BusinessLayer.Repositories.IBasketItemRepository
    {
        public BasketItemRepository()
        { }

        public BasketItemRepository(IotshopContext context)
            :base(context)
        { }

namespace Iotshop.BusinessLayer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Iotshop.BusinessLayer.Context.IotshopContext>
    {
        ...
        protected override void Seed(IotshopContext context)
        {
        ...
        private List<Device> ReadDevices(IotshopContext context)
        {
        ...
        private List<OS> GetDeviceOS(IotshopContext context, String part)
        {
        ...
        private List<Framework> GetFrameworkOS(IotshopContext context, String part)
        {
            String[] parts = part.Split('-');
            List<Framework> frameworks = new List<Framework>();
            foreach (String tempPart in parts)

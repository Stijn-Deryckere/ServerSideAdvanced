namespace Week2Oefening1.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Week2Oefening1.BusinessLayer.Context.ApplicationDbContext>
    {
        ...
        {
            String filepath = AppDomain.CurrentDomain.BaseDirectory + "/../App_Data/Data/Os.txt";
        ...
        {
            String filepath = AppDomain.CurrentDomain.BaseDirectory + "/../App_Data/Data/ProgrammingFramework.txt";
            StreamReader osr = new StreamReader(filepath);
            osr.ReadLine();
